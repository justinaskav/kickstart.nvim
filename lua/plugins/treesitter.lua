    ...
    config = function()
      ...
      vim.defer_fn(function()
        ...
        require('nvim-treesitter.configs').setup {
          ...
          ensure_installed = { 'blade', 'php_only', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'vue', 'json', 'r', 'markdown', 'markdown_inline', 'yaml', 'query', 'latex', 'html', 'css', 'astro', 'php', 'phpdoc', 'csv', 'tsv', 'mermaid', 'typst', 'rust' },
          auto_install = false,
